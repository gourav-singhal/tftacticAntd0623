...
const ItemsPage = React.lazy(() => import('@app/pages/TeamFightActics/ItemsPage'));
const SynergysPage = React.lazy(() => import('@app/pages/TeamFightActics/SynergysPage'));
const TeamCompsPage = React.lazy(() => import('@app/pages/TeamFightActics/TeamCompsPage'));
const ChampionsPage = React.lazy(() => import('@app/pages/TeamFightActics/ChampionsPage'));
...
// TFT
const Items = withLoading(ItemsPage);
const Synergys = withLoading(SynergysPage);
const TeamComps = withLoading(TeamCompsPage);
const Champions = withLoading(ChampionsPage);
    ...
    <BrowserRouter>
      <Routes>
        <Route path={NFT_DASHBOARD_PATH} element={protectedLayout}>
          ...
          <Route path="synergys" element={<Synergys />} />
