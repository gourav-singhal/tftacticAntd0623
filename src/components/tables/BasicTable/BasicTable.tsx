...
export const BasicTable: React.FC<propsType> = (props: propsType) => {
  ...
  const fetch = useCallback(
    (pagination: Pagination) => {
      setTableData({
        data: itemsData.map((item: DocumentData) => {
          return {
            ...item,
            key: item.id
          }
        }), pagination: { ...pagination, total: itemsData.length }, loading: isLoading
      });
    },
    [itemsData, isLoading],
  );
